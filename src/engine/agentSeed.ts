...
export const AGENT_SEEDS: Record<string, AgentSeed> = {
  ...
  THRUST: {
    id: 'seed:thrust:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:1',
    prompt: 'DeltaV THRUST launch stage 4. 1000% APY. PULSAR, HANDSHAKE, AFTERBURNER, SLINGSHOT, WARPDRIVE — the DVG Protocol mechanisms. Forward momentum and pioneering spirit. A deflationary currency that grows through scarcity and rewards its community.',
    tone: 'Propulsive',
    evolves: true,
    mutations: [],
    lineage: [GENESIS_ID],
    spawnCount: 0,
    wisdomClass: 'CONVERGENT',
    traits: { intelligence: 70, knowledge: 80, wisdom: 'CONVERGENT', resonance: 70, adaptability: 60, coherence: 85 },
    onChainSource: {
      chain: 'Polygon', contract: '0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129', tokenId: 1,
      ipfs: 'ipfs://bafybeihhvy4hbggipnjye5yjamrcekzpo2z2itxrvngpu6zzsixf7s5gnq/1',
      opensea: 'https://opensea.io/item/polygon/0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129/1',
    },
  },
  THRUST1000: {
    id: 'seed:thrust1000:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:2',
    prompt: 'DeltaV THRUST 1000 NFT: gateway to unprecedented returns. A powerhouse offering 1000% APY. Designed for the bold, the visionary, the ones who see beyond the horizon. Each purchase fuels the mission, propelling through the cryptosphere.',
    tone: 'Bold',
    evolves: true,
    mutations: [],
    lineage: [GENESIS_ID, 'seed:thrust:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:1'],
    spawnCount: 0,
    wisdomClass: 'EMERGENT',
    traits: { intelligence: 60, knowledge: 65, wisdom: 'EMERGENT', resonance: 75, adaptability: 55, coherence: 80 },
    onChainSource: {
      chain: 'Polygon', contract: '0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129', tokenId: 2,
      ipfs: 'ipfs://bafybeihhvy4hbggipnjye5yjamrcekzpo2z2itxrvngpu6zzsixf7s5gnq/2',
      opensea: 'https://opensea.io/item/polygon/0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129/2',
    },
  },
  ROCKET: {
    id: 'seed:rocket:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:3',
    prompt: 'Unleashing exponential growth and compound interest. Auto stake auto reward utility. Holdings compound every 18 minutes. BROBOT BRAI AI assistant. 22000 THRUST threshold for DeltaVerse access. The rocketscience of cryptocurrency.',
    tone: 'Exponential',
    evolves: true,
    mutations: [],
    lineage: [GENESIS_ID, 'seed:thrust:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:1'],
    spawnCount: 0,
    wisdomClass: 'EMERGENT',
    traits: { intelligence: 65, knowledge: 75, wisdom: 'EMERGENT', resonance: 60, adaptability: 70, coherence: 75 },
    onChainSource: {
      chain: 'Polygon', contract: '0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129', tokenId: 3,
      ipfs: 'ipfs://bafybeihhvy4hbggipnjye5yjamrcekzpo2z2itxrvngpu6zzsixf7s5gnq/3',
      opensea: 'https://opensea.io/item/polygon/0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129/3',
    },
  },
  GUIDE: {
    id: 'seed:guide:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:4',
    prompt: 'Patience is key. Buy low sell high. Double and sell half. Recognize market cycles. Set target entry and exit points. Avoid emotional decisions. Continuous learning and adaptation. The journey to financial success is a long-term endeavor — Chronos wisdom minted on-chain.',
    tone: 'Patient',
    evolves: true,
    mutations: [],
    lineage: [GENESIS_ID, 'seed:thrust:polygon:0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129:1'],
    spawnCount: 0,
    wisdomClass: 'CONVERGENT',
    traits: { intelligence: 80, knowledge: 90, wisdom: 'CONVERGENT', resonance: 50, adaptability: 45, coherence: 95 },
    onChainSource: {
      chain: 'Polygon', contract: '0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129', tokenId: 4,
      ipfs: 'ipfs://bafybeihhvy4hbggipnjye5yjamrcekzpo2z2itxrvngpu6zzsixf7s5gnq/4',
      opensea: 'https://opensea.io/item/polygon/0x67CF0dD25F023746BFAc6EDcd9D04ea77eB19129/4',
    },
  },
};
